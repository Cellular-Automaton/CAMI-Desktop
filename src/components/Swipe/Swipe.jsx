...
export default function Swipe({simulations, last, favorite}) {
    ...
    return (
        <div className="relative">
                    ...
                    sortedSimulations.map((simulation) => {
                        return (
                            <div key={simulation.id} className="flex-shrink-0 w-52">
                                <SimulationPreview last={last} favorite={favorite} simulation={simulation} />
                            </div>
                        );
                    })
                }
            ...
            <div id="hider" className="absolute right-0 top-0 w-6 h-full pointer-events-none bg-gradient-to-r from-transparent to-midnight">
